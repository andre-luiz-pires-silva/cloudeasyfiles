...
CloudEasyFiles needs to support archival restore workflows, starting with AWS S3 Glacier and related archival tiers.
...
- future Azure rehydration has different options and semantics
...
- Future Azure support remains free to use a different restore or rehydration workflow.
